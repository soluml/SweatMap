...
describe("SweatMap", function () {
  ...
  describe("set(key)", function () {
    ...
    it("Obfuscates the given keys correctly:", function () {
      ...
      for (i = 0; i < 5000; i++) {
        ...
        if (i < 52) {
          ...
          //(^)[A] + (52*52)[AA] + (1776)[B] == 4532
          assert.equal(myMap.bytes(str), 2);
        } else {
          //(^)[A][AA][B] + (52*52*52)[AAA] + (1776*52)[BA] + (52*1776)[AB] + (57440)[C] ==   4532 + 140608 + 92532 + 92352 + 57440 == 387644
    ...
    it("Obfuscates the given keys correctly (CSS Safe):", function () {
      ...
      var i,
        str,
        myOtherMap = new SweatMap({ cssSafe: true });
      ...
      for (i = 0; i < 5300; i++) {
        ...
        if (i < 53) {
          ...
          //(53)[A]+ (54*64-11{--, -\d})[AA] + (1776)[B] == 5274
          assert.equal(myMap.bytes(str), 2);
        } else {
          assert.equal(myMap.bytes(str), 3);
        }
